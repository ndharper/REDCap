...
api_url = URL
api_key = '4C585D78D78C87AF2F1A440CA527A722'

records_of_interest= []
records_of_interest.append(sys.argv[1].strip())
outfile_name = sys.argv[1].strip() +".json"
...
fields_of_interest = ['participationid', 'scan_validation','scan_req_ack',
                      ...
                      'fscan_ga_at_scan_weeks','fscan1_complete','fscan1_failure_reason','fscan1_failure_reason_other',
                      'fscan1_comments','fscan2_complete','fscan2_failure_reason','fscan2_failure_reason_other',
                      'fscan2_comments','fscan_2nd',
                      'nscan_ga_at_scan_weeks','nscan_age_at_scan_days','xscan_baby_weight','scan_completed','scan_failure_reason',
                      'scan_failure_reason_other','scan_comments'
...
#fields = {
#    'token': '4C585D78D78C87AF2F1A440CA527A722',
#    'content': 'arm',
#    'format': 'json'
#}
...
data = project.export_records(records=records_of_interest,fields=fields_of_interest,events=events_of_interest,format='json',raw_or_label='label')
